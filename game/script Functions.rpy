...
#                                            $ Options[0] = "Emma"                            
                ...
                #End night time
                    ...
                    if bg_current == "bg rogue":
                            ...
                            if E_Loc == bg_current:
                                ch_e "I wouldn't mind if you stayed a bit."     
                            else:
                            ...
                            if Current_Time == "Night" and E_Loc == bg_current:               
                                if E_Sleep or E_SEXP >= 30:                                                         
                                        #It's late but she really likes you
                                        ch_e "It's getting a bit late, [E_Petname], but you can stay if you like. . ."   
                                elif ApprovalCheck("Emma", 1000, "LI") or ApprovalCheck("Emma", 600, "OI"):           
                                        #It's late but she really likes you
                                        ch_e "It's getting a bit late, [E_Petname], but you can stay for a bit."     
                                else:                                                                                   
                                        #she likes you well enough but it's late so you should go
...
label Seen_First_Peen(Primary=0, Secondary=0, Silent=0, Undress=0, Passive=0, GirlsNum=0, React=0):
    ...
    if not Primary:
            ...
            if Primary == "Rogue":
                    call Rogue_First_Peen(React=React)               
            elif Primary == "Kitty":
                    call Kitty_First_Peen(React=React)
            elif Primary == "Emma":
                    call Emma_First_Peen(React=React)
                
            if not Secondary: 
                    pass
            elif Secondary == "Rogue":
                    call Rogue_First_Peen(Second = _return)
            elif Secondary == "Kitty":
                    call Kitty_First_Peen(Second = _return)
            elif Secondary == "Emma":
                    call Emma_First_Peen(Second = _return)
...
label Girls_Arrive(Primary = 0, Secondary = 0, GirlsNum = 0, NumPresent = 0):
    ...
    if bg_current == "bg player":
            ...
            #Determines who sits next to you
                            ...
                            ch_k "Oh, hey."
                            if not Secondary and not Adjacent and ApprovalCheck("Kitty", 1000):    
