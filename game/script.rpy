...
#Rogue Stats   
    ...
    # nude(0), green(1), pink(2), Custom1(3), Sleepwear(4), Custom2(5), Custom3(6), Gymclothes(7), Temporary(8)
    ...
    if SaveVersion < 981:
        ...
        if ("movie" in P_DailyActions or "dinner" in P_DailyActions) and not Party:
                ...
                $ Party = [Primary,Secondary]
                    # I believe this will keep Primary and Secondary if they exist, or reset them to zero if not. 
                    # I then believe it will asign them to the Party if they exist. 
                    
#                    "If you are loading from a previous version during a date, the rest of the date might get buggy."
#                    "To fix this, I'm giving the option to reset the night and return to your room." 
#                    "If you continue and it gets weird, maybe revert to the save. :D"
#                    menu:
#                        "Reset the date?"
#                        "Yes":   
#                            show blackscreen onlayer black 
...
label EventCalls:
        ...
        if Current_Time == "Evening" and bg_current == "bg campus" and "yesdate" in P_DailyActions:
                    call DateNight
...
label Taboo_Buddy_Check(Girl="Rogue"):
    #checks if the girl si comfortable with the other girls present
    if Girl == "Rogue":
