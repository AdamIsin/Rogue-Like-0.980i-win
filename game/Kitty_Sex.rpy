                                    ...
                                    "Threesome actions" if Partner:   
                                        menu:
                                            ...
                                            "Ask [Partner] to do something else":
                                                        if Partner == "Rogue":
                                                            call Rogue_Three_Change("Kitty")
                                                        elif Partner == "Emma":
                                                            call Emma_Three_Change("Kitty")                                                  
...
label Kitty_Noticed(Other = "Rogue", Silent=0, B = 0):
    if Partner == "Kitty" and "noticed rogue" in K_RecentActions and Other == "Rogue":
            return
    if Partner == "Kitty" and "noticed emma" in K_RecentActions and Other == "Emma":
            return     
