...
label Remove_Panties(chr = "Rogue", Store = 0, Store2 = 0):
    ...
    # End Rogue's options
                ...
                if Taboo:
                        if Store == "black jeans" or Store == "capris":
                            "Kitty looks around, but pulls her pants clean off and her panties with them."
                        elif Store == "skirt" and Store2 != K_Hose:
                            "Kitty looks around, hikes up her skirt, pulls her [Store2] clean off and her panties with them."
                        elif Store == "skirt":               
                            "Kitty looks around, reaches under her skirt, and pulls her panties down."
                        elif Store2 != K_Hose:  
                            "Kitty looks around, but pulls her [Store2] clean off and her panties with them." 
                        else:  
                            "Kitty looks around, but pulls her panties off." 
                else: #Not Taboo
                        if Store == "black jeans" or Store == "capris":
                            "Kitty glances at you and pulls her pants clean off and her panties with them."
                        elif Store == "skirt" and Store2 != K_Hose:
                            "Kitty glances at you, hikes up her skirt, pulls her [Store2] clean off and her panties with them."
                        elif Store == "skirt":
                            "Kitty glances at you, reaches under her skirt, and pulls her panties down."
                        elif Store2 != K_Hose:
                            "Kitty glances at you and pulls her [Store2] clean off and her panties with them."
                        else:
                            "Kitty glances at you and pulls her panties off."
                        
                $ K_Legs = Store  
                $ K_Hose = Store2      
                if Store == "black jeans" or Store == "capris":
                    "She hands you the panties and then pulls her pants back on."
                elif K_Legs == "skirt" and HoseNum("Kitty") >= 5:
                    "She hands you the panties and then pulls her [K_Hose] back on and her skirt back down."  
                    $ K_Upskirt = 0
                elif K_Legs == "skirt":        
                    "She hands you the panties and then pulls her skirt back down."  
                    $ K_Upskirt = 0    
                elif HoseNum("Kitty") >= 5:
                    "She hands you the panties and then pulls her [K_Hose] back on."  
                else:
                    "Kitty hands them to you in a ball." 
...
label R_Private_Outfit:
    ...
    if "comfy" in R_RecentActions:
            call R_AltClothes(9)
            call RogueOutfit(Changed=1)
    elif "no comfy" in R_RecentActions:
            pass        
    elif (2 * R_Inbt) >= (R_Love + R_Obed) or "comfy" in R_Traits:
