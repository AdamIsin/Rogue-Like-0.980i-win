...
label Emma_Noticed(Other = "Rogue", Silent=0, B = 0):
    if Partner == "Emma" and "noticed rogue" in E_RecentActions and Other == "Rogue":
            return
    if Partner == "Emma" and "noticed kitty" in E_RecentActions and Other == "Kitty":
            return
