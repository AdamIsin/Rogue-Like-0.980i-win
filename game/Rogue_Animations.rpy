...
image Rogue_Doggy_Ass = LiveComposite(                                                                                          #Lower body
        ...
        (0,0), ConditionSwitch(    
            ...
            "P_Sprite and P_Cock == 'in'", ConditionSwitch(                     
                    "Speed > 2", "Rogue_Pussy_Fucking3",
                    "Speed > 1", "Rogue_Pussy_Fucking2",
                    "Speed", "Rogue_Pussy_Moving",
                    "True", "Rogue_Pussy",  
                    ),   
...
#            ),   
        ...
        (0,0), ConditionSwitch(    
            ...
            "P_Sprite and P_Cock == 'anal'", ConditionSwitch(                     
                    "Speed > 2", "Rogue_Anal_Fucking2",
                    "Speed > 1", "Rogue_Anal_Fucking",
                    "Speed", "Rogue_Anal_Heading",
                    "True", "Rogue_Anal",  
                    ),    
...
#    contains:
#        #edit to include various pants and hose
#        ConditionSwitch(     
#            "R_Legs == 'pants'", "images/RogueDoggy/Rogue_Doggy_Tights_Wet.png",
#            "R_Hose == 'garterbelt'", "images/RogueDoggy/Rogue_Doggy_Stockings_Loose.png",    
#            "R_Hose == 'stockings and garterbelt'", "images/RogueDoggy/Rogue_Doggy_Stockings.png",   
#            "R_Hose == 'tights'", "images/RogueDoggy/Rogue_Doggy_Tights.png",
#            "R_Hose == 'pantyhose'", "images/RogueDoggy/Rogue_Doggy_FullHose.png",   
...
label AllReset(chr = "Rogue"): 
    if chr == "Rogue" or chr == "all":
        ...
        if R_Loc == bg_current:
            ...
            show Rogue:
                zoom 1 offset (0,0) anchor (0.6, 0.0)
        else:
            hide Rogue
    if chr == "Kitty" or chr == "all":
        ...
        if K_Loc == bg_current:
            ...
            show Kitty_Sprite:
                zoom 1 offset (0,0) anchor (0.5, 0.0)
        else:
            hide Kitty_Sprite
