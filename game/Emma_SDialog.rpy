...
label Emma_SexDialog(TempLine = 0, TempLust = 0, TempLust2 = 0):
    ...
    # end E_Blowjob                                 //////////////////////////////////////////////////////////////////////////////
            ...
            if not Speed: #if Emma is not moving   
                    $ Line = "She slowly sliders her pussy against your cock. . "
                    return
                        
            elif Speed < 2: 
                    $ Line = "Emma continues to bounce on your cock. "    
            else: 
                    $ Line = "Emma continues to slide up and down your cock. " 
            
            if E_Sex > 4:
                if Speed > 1:                       # After the 5th time fast
                        $ Line = Line + renpy.random.choice(["She's moving pretty quickly", 
                            "You thrust into her and she squeaks a bit",
                            "You quickly grind back and forth inside her",
                            "She drives hard against you",
                            "She's moving faster now",
                            "She's slowing it down slightly",
                        ...
                        $ Line = Line + renpy.random.choice(["She bumps slowly along it", 
                            "You thrust into her and she coos a bit",
                            "You slowly grind back and forth inside her",
                            "She drives slowly against you",
                            "She's moving faster now",
                            "She's slowing it down slightly",
                ...
                if Speed > 1:             #third through 5th time fast
                    ...
                    $ Line = Line + renpy.random.choice(["she bumps slowly against your cock", 
                        ...
                        "She's moving faster now",
                        "She's slowing it down slightly",
                        "You alternate between long and short thrusts",
                        "You slowly slide back and forth near the entrance",    
    ...
    # end E_Sex                                 ////////////////////////////////////////////////////////////////////////////// 
            ...
            if not Speed:
                $ Line = "She just slowly glides along your shaft. . "
                return
            else: 
                    $ Line = "She continues to slide along your cock. "   
                    
            if E_Hotdog >= 2:
                if Speed > 1:       # After the 2ndtime fast
                    $ Line = Line + renpy.random.choice(["She slides rapidly against your cock", 
    ...
    # end E_Hotdog                                 //////////////////////////////////////////////////////////////////////////////
            ...
            if not Speed:
                $ Line = "Emma slowly rubs the tip against her hole. . "
                return
                
            elif Speed < 2: 
                    $ Line = "Emma continues to slam against your cock. "    
            elif Speed < 1: 
                    $ Line = "Emma continues to slider your cock deep inside her. "      
            else: 
                    $ Line = "Emma continues to press the tip of your cock into her. "                     
                    $ TempFocus += 8 if P_Focus > 60 else 6                   
                    $ TempLust += 10 if 50 < E_Lust < 90 else 6
                 
            if Speed > 2:#Fast
                    $ Line = Line + renpy.random.choice(["She bounces rapidly against your cock", 
                        "She thrusts onto you and she moans a bit",
                        "You quickly grind back and forth inside her",
                        "You alternate between shallow rapid thrusts, and the occasional deep, slow one",
                        "She pounds away on you",    
                        "She grinds furiously back and forth along your cock"])
                    ...
                    $ Line = Line + renpy.random.choice(["She bumps slowly against your cock", 
                        "You thrust into her and she coos a bit",
                        "You slowly grind back and forth inside her",
                        "You alternate between long and slow thrusts",
...
#                $ TempLust = 0
    ...
    elif Trigger == "foot": #fix when footjobs added
...
label Emma_Self_Lines(Mode = "T3", Action = Trigger3, TempLustX = 0): 
    ...
    if Action == "hand": 
        ...
        if Partner != "Emma": #If this is a primary, Trigger3 action
            $ TempLust = TempLustX
...
label Emma_Self_Set(Mode = "T3", Action = Trigger3, Length=0, Count2=0, Options =[]): 
    ...
    if Trigger == "masturbation":
                ...
                if Mode != "T5" and Trigger in ("fondle pussy", "fondle breasts", "fondle thighs", "kiss you", "fondle ass", "suck breasts") and E_Hand >= 5:
                        $ Options.append("hand")
...
label Emma_SexDialog_Threeway(Mode = 0, Action = 0, ActiveGirl = Primary, TempLine = 0, TempLust = 0, TempLust2 = 0, TempFocus = 0):
    ...
    # end E Masturbation Threeway                              /////////////////////////////////////////////////////////////////////////////
                        ...
                        if Trigger == "blow" and E_Blow > 5 and Trigger4 == "kiss you":
                        ...
                        elif Trigger == "blow" and Trigger4 == "kiss you":
                                    $ Line = "Emma also continues to kiss " + ActiveGirl
                                    ...
                                    if Action == "kiss girl" or Mode == "lesbian":
                                        if Trigger == "lesbian" and Partner != "Emma":
                                                $ Line = "Emma continues to make out with " + ActiveGirl
                                        else:                                            
...
label Emma_Threeway_Set(Preset = 0, Mode = 0, Action = Trigger4, ActiveGirl = Primary, State = "watcher", TempLust = 0, TempLust2 = 0, TempFocus = 0):
            ...
            if not Preset:                     
                    ...
                    if Mode == "lesbian":
                            ...
                            if Trigger3 == "kiss girl" and E_Lust <= 20 and E_Org < 1:
            ...
            if Trigger == "lesbian":
                    ...
                    if Preset in ("hand","blow","kiss you","kiss both"):
                            ...
                            pass
                    elif ActiveGirl == "Rogue" and E_LikeRogue >= 600 and ApprovalCheck("Emma", 500, "I"):
                            pass
                    elif ActiveGirl == "Kitty" and E_LikeKitty >= 600 and ApprovalCheck("Emma", 500, "I"):
                            pass
                    else:
                            #this returns if she doesn't like the other girl enough to do anything more.
                            if Action != "kiss girl":                                
                                    $ Line = "Emma gives " + ActiveGirl + " a passionate kiss" #use T5 on this to choose targets
                                    $ Action = "kiss girl"   
                                    $ Trigger3 = "kiss girl"
                    ...
                    if E_LikeRogue >= 600 and ApprovalCheck("Emma", (1500-(10*E_Les)-(10*(E_LikeRogue-60)))): #If she likes both of you a lot, threeway
                            $ State = "threeway"
                    ...
                    if E_LikeKitty >= 600 and ApprovalCheck("Emma", (1500-(10*E_Les)-(10*(E_LikeKitty-60)))): #If she likes both of you a lot, threeway
                            $ State = "threeway"
                    elif ApprovalCheck("Emma", 1000): #If she likes you well enough, Hetero
                            $ State = "hetero"            
...
#                                $ Options.append("vibrator") 
            ...
            if Options[0] == "masturbation":
                        ...
                        call Seen_First_Peen("Emma",ActiveGirl,React=1)
...
#            elif Options[0] == "vibrator":    
                        ...
                        $ Line = "Emma seems content to just watch the two of you"
                        $ Action = "watch"
                        if ActiveGirl == "Rogue": #If Emma is watching Rogue
                                $ TempLust += 1 if E_LikeRogue >= 600 else 0  # Emma's lust
                                $ TempLust += 2 if E_LikeRogue >= 800 else 1  # Emma's lust
                                $ TempLust2 += 1 if ApprovalCheck("Rogue", 500, "I") else 0
                                $ TempLust2 += 1 if ApprovalCheck("Rogue", 700, "I") else 0
            ...
            if Action == "kiss girl" or Action == "kiss both":
                    ...
                    if "lesbian" not in E_RecentActions:
                            $ E_Les += 1
                            $ E_RecentActions.append("lesbian") 
                    if ActiveGirl == "Rogue": #If Emma is kissing Rogue
                            $ TempLust += 1 if ApprovalCheck("Emma", 500, "I") else 0  # Emma's lust
                            $ TempLust += 1 if E_LikeRogue >= 800 else 0
                            $ TempLust2 += 2 if R_LikeEmma >= 800 else 1
                    elif ActiveGirl == "Kitty": #If Emma is kissing Kitty
            ...
            if Mode == "lesbian":
                ...
                #Sets Emma's action and Lust if this is a starting action
                $ Trigger4 = Action
                $ E_Lust += TempLust2
            else:
